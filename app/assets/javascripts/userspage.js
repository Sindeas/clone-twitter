...
$(".userspage.index").ready(function(){
      ...
      $.each(tweets, function(index){
        if(tweets[index]['username'] === currentUser) {
          $('.feed').append(
            ...
            <a class="tweet-username" href="/userspage">'+tweets[index]['username']+'</a> \
            <a class="tweet-screenName" href="/userspage">@'+tweets[index]['username']+'</a> \
    ...
    getUserTweets(username, function(response) {
      ...
      $.each(response, function(index){
        if(response[index]['username'] === currentUser) {
          $('.feed').append(
            '<div class="tweet col-xs-12"> \
            <a class="tweet-username" href="/userspage">'+response[index]['username']+'</a> \
            <a class="tweet-screenName" href="/userspage">@'+response[index]['username']+'</a> \
